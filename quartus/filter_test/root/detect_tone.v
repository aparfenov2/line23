...
module detect_tone
  ...
  input   signed [15:0] thd_lev_0;  // int16
  input   signed [15:0] thd_lev_1;  // int16
  input   signed [15:0] thd_lev_2;  // int16
  input   signed [15:0] thd_lev_3;  // int16
  input   signed [15:0] thd_lev_4;  // int16
  input   signed [15:0] thd_lev_5;  // int16
  input   signed [15:0] bits_thd_0;  // int16
  input   signed [15:0] bits_thd_1;  // int16
  input   signed [15:0] bits_thd_2;  // int16
  input   signed [15:0] bits_thd_3;  // int16
  input   signed [15:0] bits_thd_4;  // int16
  input   signed [15:0] bits_thd_5;  // int16
  output  ce_out;
  ...
  detect_threshold_detect_threshold   u_detect_threshold   (.clk(clk),
                                                            .reset(reset),
                                                            .enb(clk_enable),
                                                            .abs_in(Abs1_out1),  // int16
                                                            .thd(thd_lev_0),  // int16
                                                            .bits_thd(bits_thd_0),  // int16
                                                            .bit_out(detect_threshold_out1)
                                                            );
  ...
  detect_threshold_detect_threshold   u_detect_threshold1   (.clk(clk),
                                                             .reset(reset),
                                                             .enb(clk_enable),
                                                             .abs_in(Abs2_out1),  // int16
                                                             .thd(thd_lev_1),  // int16
                                                             .bits_thd(bits_thd_1),  // int16
                                                             .bit_out(detect_threshold1_out1)
                                                             );
  ...
  detect_threshold_detect_threshold   u_detect_threshold2   (.clk(clk),
                                                             .reset(reset),
                                                             .enb(clk_enable),
                                                             .abs_in(Abs3_out1),  // int16
                                                             .thd(thd_lev_2),  // int16
                                                             .bits_thd(bits_thd_2),  // int16
                                                             .bit_out(detect_threshold2_out1)
                                                             );
  ...
  detect_threshold_detect_threshold   u_detect_threshold3   (.clk(clk),
                                                             .reset(reset),
                                                             .enb(clk_enable),
                                                             .abs_in(Abs4_out1),  // int16
                                                             .thd(thd_lev_3),  // int16
                                                             .bits_thd(bits_thd_3),  // int16
                                                             .bit_out(detect_threshold3_out1)
                                                             );
  ...
  detect_threshold_detect_threshold   u_detect_threshold4   (.clk(clk),
                                                             .reset(reset),
                                                             .enb(clk_enable),
                                                             .abs_in(Abs5_out1),  // int16
                                                             .thd(thd_lev_4),  // int16
                                                             .bits_thd(bits_thd_4),  // int16
                                                             .bit_out(detect_threshold4_out1)
                                                             );
  ...
  detect_threshold_detect_threshold   u_detect_threshold5   (.clk(clk),
                                                             .reset(reset),
                                                             .enb(clk_enable),
                                                             .abs_in(Abs6_out1),  // int16
                                                             .thd(thd_lev_5),  // int16
                                                             .bits_thd(bits_thd_5),  // int16
                                                             .bit_out(detect_threshold5_out1)
                                                             );
