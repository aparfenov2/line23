...
// 
// Module: f7395
// Source Path: root/detect_tone/f7395
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module f7395
  ...
  wire signed [31:0] s_1_mul_temp;  // sfix32_En19
  ...
  wire signed [31:0] s_2_mul_temp;  // sfix32_En19
  ...
  assign s_1_mul_temp = 25042 * ConvertIn_out1;
  ...
  assign a_3_1_out1 = 15561 * Delay21_out1;
  ...
  assign a_2_1_out1 = -19240 * Delay11_out1;
  ...
  assign b_2_1_out1 = 31093 * Delay11_out1;
  ...
  assign s_2_mul_temp = 25042 * CastStageIn2_out1;
  assign s_2_out1 = ({{3{s_2_mul_temp[31]}}, s_2_mul_temp[31:19]}) + $signed({1'b0, s_2_mul_temp[18] & (s_2_mul_temp[19] | (|s_2_mul_temp[17:0]))});
  ...
  assign a_3_2_out1 = 15512 * Delay22_out1;
  ...
  assign a_2_2_out1 = -16931 * Delay12_out1;
  ...
  assign b_2_2_out1 = -32637 * Delay12_out1;
